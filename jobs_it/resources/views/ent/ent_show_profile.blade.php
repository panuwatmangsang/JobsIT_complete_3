                ...
                <div class="card-body">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="text" class="form-control" name="profile_name_company" value="{{$profiles->profile_name_company}}" placeholder="กรุณากรอกชื่อบริษัท">
                        </div>

                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="rank">ชื่อผู้ติดต่อ</label>
                                <input readonly type="text" class="form-control" name="profile_company_contact" value="{{$profiles->profile_company_contact}}" placeholder="กรุณากรอกชื่อผู้ติดต่อ">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="quantity">เบอร์โทรศัพท์</label>
                                <input readonly type="text" class="form-control" name="profile_company_phone" value="{{$profiles->profile_company_phone}}" placeholder="เบอร์โทรศัพท์">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="nameCompany">อีเมล</label>
                            <input readonly type="text" class="form-control" name="profile_email" value="{{$profiles->profile_email}}" placeholder="กรุณากรอกอีเมล">
                        </div>

                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">ที่อยู่ของบริษัท</label>
                            <textarea readonly class="form-control" name="profile_company_address" id="exampleFormControlTextarea1" rows="8">{{$profiles->profile_company_address}}</textarea>
